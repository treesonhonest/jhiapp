  ...
  return (
    <div>
      <h2 id="teacher-heading">
        <Translate contentKey="jhiappApp.teacher.home.title">Teachers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhiappApp.teacher.home.createLabel">Create new Teacher</Translate>
        </Link>
      </h2>
        ...
        {teacherList && teacherList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhiappApp.teacher.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jhiappApp.teacher.age">Age</Translate>
                </th>
                <th>
                  <Translate contentKey="jhiappApp.teacher.kemu">Kemu</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhiappApp.teacher.home.notFound">No Teachers found</Translate>
            </div>
          )
        )}
      </div>
